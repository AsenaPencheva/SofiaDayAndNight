...
{
    [TestFixture]
    class CancelFriendRequest_Should
    {
        [Test]
        public void CallSendRequest_WhenCalled()
        {
            ...
            // Assert
            mockedIndividualService.Verify(x => x.CancelFriendRequest(It.IsAny<string>(), It.IsAny<Guid>()), Times.Once);
        }
        ...
        public void ReturnPartialViewwithCorrectModel_WhenIsAjax()
        {
            ...
            //Act & Assert
            controller
             .WithCallTo(x => x.CancelFriendRequest(Guid.NewGuid()))
