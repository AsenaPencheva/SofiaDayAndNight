...
{
    [TestFixture]
    public class ConfirmFriendship_Should
    {
        [Test]
        public void CallSendRequest_WhenCalled()
        {
            ...
            mockedIndividualService.Setup(x => x.ConfirmFriendship(It.IsAny<string>(), It.IsAny<Guid>())).Verifiable();
            ...
            // Act
            controller.ConfirmFriendship(Guid.NewGuid());

            // Assert
            mockedIndividualService.Verify(x => x.ConfirmFriendship(It.IsAny<string>(), It.IsAny<Guid>()), Times.Once);
        }
        ...
        public void ReturnPartialViewwithCorrectModel_WhenIsAjax()
        {
            ...
            //Act & Assert
            controller
             .WithCallTo(x => x.ConfirmFriendship(Guid.NewGuid()))
