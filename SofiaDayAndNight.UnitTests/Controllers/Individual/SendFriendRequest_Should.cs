...
namespace SofiaDayAndNight.UnitTests.Controllers.Individual
{
    ...
    public class SendFriendRequest_Should
    {
        ...
        public void CallSendRequest_WhenCalled()
        {
            ...
            mockedIndividualService.Setup(x => x.SendFriendRequest(It.IsAny<string>(), It.IsAny<Guid>())).Verifiable();
            ...
            // Act
            controller.SendFriendRequest(Guid.NewGuid());

            // Assert
            mockedIndividualService.Verify(x => x.SendFriendRequest(It.IsAny<string>(), It.IsAny<Guid>()), Times.Once);
        }
        ...
        public void ReturnPartialViewwithCorrectModel_WhenIsAjax()
        {
            ...
            //Act & Assert
            controller
             .WithCallTo(x => x.SendFriendRequest(Guid.NewGuid()))
