...
namespace SofiaDayAndNight.UnitTests.Controllers.Organization
{
    ...
    {
        [Test]
        public void CallFollow_WhenCalled()
        {
            // Arrange
            var username = "testUser";
            var mockedOrganizationService = new Mock<IOrganizationService>();
            mockedOrganizationService.Setup(x => x.Follow(It.IsAny<string>(), It.IsAny<Guid>())).Verifiable();
            ...
            // Act
            controller.Follow(Guid.NewGuid());

            // Assert
            mockedOrganizationService.Verify(x => x.Follow(It.IsAny<string>(), It.IsAny<Guid>()), Times.Once);
        }
        ...
        public void ReturnPartialViewwithCorrectModel_WhenIsAjax()
        {
            ...
            //Act & Assert
            controller
             .WithCallTo(x => x.Follow(Guid.NewGuid()))
